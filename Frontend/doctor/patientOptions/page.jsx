    ...
    <div className={`min-h-screen flex flex-col ${outfit.className}`}>
      ...
      <header className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 font-medium">Patient Options</p>
          </div>
        </div>
      ...
      >
        ...
        <div className="w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-30 z-10 max-w-4xl ml-140">
            {[
              {
                title: 'View My Patients',
                href: '/doctor/viewAllPatients',
                icon: faUsers,
              },
              {
                title: 'Add a New Patient',
                href: '/doctor/addPatient',
                icon: faUserPlus,
              },
